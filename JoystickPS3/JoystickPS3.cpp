...
bool JoystickPS3::baca_data()
{
    ...
    // printf("%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n", this->button, this->RL, this->button_click, this->RL_click, this->R2, this->L2, this->LX, this->LY, this->RX, this->RY);
    // printf("%d\n", this->button);
    // printf("button: %d, RL: %d, button_click: %d, RL_click: %d\n", this->button, this->RL, this->button_click, this->RL_click);
    // printf("R2: %d, L2: %d\n", this->R2, this->L2);
    // printf("LX: %d, LY: %d, RX: %d, RY: %d\n", this->LX, this->LY, this->RX, this->RY);
    // printf("\n");
    // printf("get data: %ld\n", us_ticker_read()-a);
    return true;
}
